...
public class CreateFormValidationTest {
    ...
    public void invalidCreateFormShouldReport3Errors() {
        ...
        createForm.setInitialDeposit(new BigDecimal(0)); // must be >= 1
        createForm.setOverdraftLimit(new BigDecimal(11)); // 10 is limit
    ...
    public void validFormShouldResultInNoErrors() throws Exception {
        ...
        createForm.setInitialDeposit(new BigDecimal(10));
        createForm.setOverdraftLimit(new BigDecimal(5));
